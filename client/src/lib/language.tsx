...
export const translations = {
  ...
  ar: {
    ...
    payment: {
      ...
      visaMada: "فيزا / مدى / ماستركارد",
      applePay: "آبل باي",
      quickSecure: "سريع وآمن",
      cashOnDelivery: "الدفع عند الاستلام",
      payTechnician: "ادفع للفني نقداً",
      payTechnicianCash: "ستدفع للفني عند وصوله إلى موقعك.",
      ...
      detected: "تم اكتشاف",
      applePayReady: "سيُطلب منك المصادقة باستخدام Apple Pay عند إكمال الحجز.",
      success: "تم الدفع بنجاح",
      failed: "فشل الدفع",
      error: "خطأ في الدفع",
      transactionId: "رقم العملية",
      selectPaymentMethodFirst: "الرجاء اختيار طريقة الدفع",
      enterCardDetails: "الرجاء إدخال تفاصيل البطاقة",
      tryAgain: "الرجاء المحاولة مرة أخرى",
      somethingWentWrong: "حدث خطأ في عملية الدفع",
    },
    // Booking Details
    bookingDetails: {
